                ...
                VStack {
                    ...
                    if(!viewModel.makedTimetablesLectures.isEmpty) {
                        ...
                        HStack {
                            ...
                            // 저장버튼
                            Button(action: {
                                viewModel.saveTimetable(createdTimetable: CreatedTimetable(year: viewModel.currentYear, semester: viewModel.currentSemester, timeTableName: "auto", isRepresent: false, lectures: viewModel.makedTimetablesLectures[selectedIndex])) {
                                    showAlert = true
                                }
                            }, label: {
